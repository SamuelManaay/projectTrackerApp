            ...
            <CardContent className={textFieldClasses.textFieldSection}>
              ...
              <Grid container className={spacingClasses.marginBottom2}>
                <Grid item lg={6} md={6} xs={12}>
                  ...
                  {/* <TextField primary="Position Title" secondary={values.Position} /> */}
                  {/* <List>
              <ListItem>
                <TextField primary="Position Title"  secondary={values.Position}/>
              </ListItem>
                ...
                <Grid item lg={6} md={6} xs={12}>
                  ...
                  {/* <List>
                    <ListItem>
                      <TextField primary="Date Hire" secondary={formatDate(values.Hired)} />
                    </ListItem>
                  </List> */}
                </Grid>
                <Grid item lg={6} md={6} xs={12}>
                  <List>
                    <TextField
                      ...
                      defaultValue={formatDate(values.Regularization)}
                      size="small"
                    />
                  </List>
                  {/* <List>
                    <ListItem>
                      <TextField primary="Regularization Date" secondary={formatDate(values.Regularization)} />
                    </ListItem>
                  </List> */}
                </Grid>
                ...
                <Grid item lg={6} md={6} xs={12}>
                  <List>
                    <TextField
                      ...
                      defaultValue={values.ExtensionName}
                      size="small"
                    />
                    {/* <ListItem>
                ...
                <Grid item lg={6} md={6} xs={12}>
                  <List>
                    <TextField
                      ...
                      id="outlined-required"
                      label="Birthdate"
                      defaultValue={formatDate(values.Birthdate)}
                      size="small"
                    />
                    {/* <ListItem>
                ...
                <Grid item lg={6} md={6} xs={12}>
                  <List>
                    <TextField
                      ...
                      id="outlined-required"
                      label="Telephone No."
                      defaultValue={values.TelephoneNo}
                      size="small"
                    />
                    {/* <ListItem>
                ...
                <Grid item lg={6} md={6} xs={12}>
                  <List>
                    <TextField
                      ...
                      defaultValue={values.EmailAddress1}
                      size="small"
                    />
                    {/* <ListItem>
                ...
                <Grid item lg={6} md={6} xs={12}>
                  <List>
                    <TextField
                      ...
                      id="outlined-required"
                      label="Company Email"
                      defaultValue={values.EmailAddress2}
                      size="small"
                    />
                    {/* <ListItem>
                    ...
                    >
                      <List>
                        <TextField
                          ...
                          defaultValue={values.CurrentStreetAddress}
                          size="small"
                        />
                        {/* <ListItem>
                  ...
                  <Grid container spacing={2}>
                    ...
                    >
                      ...
                      <TextField
                          ...
                          defaultValue={values.CurrentBarangay}
                          size="small"
                        />
                        {/* <ListItem>
                  ...
                  <Grid container spacing={2}>
                    ...
                    >
                      ...
                      <TextField
                          ...
                          id="outlined-required"
                          label="Current City"
                          defaultValue={values.CurrentCityMunicipality}
                          size="small"
                        />
                        {/* <ListItem>
                  ...
                  <Grid container spacing={2}>
                    ...
                    >
                      ...
                      <TextField
                          ...
                          defaultValue={values.CurrentProvince}
                          size="small"
                        />
                        {/* <ListItem>
                ...
                <Grid container spacing={2}>
                  <Grid item lg={12} md={12} sm={12} xs={12} style={{ marginTop: 10, marginLeft: 2, marginRight: 3 }}>
                    ...
                    <TextField
                          ...
                          defaultValue={values.PermanentHouseNo}
                          size="small"
                        />
                      {/* <ListItem>
                ...
                <Grid container spacing={2}>
                  <Grid item lg={12} md={12} sm={12} xs={12} style={{ marginTop: 5, marginLeft: 2, marginRight: 3 }}>
                    ...
                    <TextField
                          ...
                          defaultValue={values.PermanentStreetAddress}
                          size="small"
                        />
                      {/* <ListItem>
                ...
                <Grid container spacing={2}>
                  <Grid item lg={12} md={12} sm={12} xs={12} style={{ marginTop: 5, marginLeft: 2, marginRight: 3 }}>
                    ...
                    <TextField
                          ...
                          defaultValue={values.PermanentBarangay}
                          size="small"
                        />
                      {/* <ListItem>
                ...
                <Grid container spacing={2}>
                  <Grid item lg={12} md={12} sm={12} xs={12} style={{ marginTop: 5, marginLeft: 2, marginRight: 3 }}>
                    ...
                    <TextField
                          ...
                          defaultValue={values.PermanentCityMunicipality}
                          size="small"
                        />
                      {/* <ListItem>
                ...
                <Grid container spacing={2}>
                  <Grid item lg={12} md={12} sm={12} xs={12} style={{ marginTop: 5, marginLeft: 2, marginRight: 3 }}>
                    ...
                    <TextField
                          ...
                          defaultValue={values.PermanentProvince}
                          size="small"
                        />
                      {/* <ListItem>
                ...
                <Grid container spacing={2}>
                  <Grid item lg={12} md={12} sm={12} xs={12} style={{ marginTop: 5, marginLeft: 2, marginRight: 3 }}>
                    ...
                    <TextField
                          ...
                          defaultValue={values.PermanentRegion}
                          size="small"
                        />
                      {/* <ListItem>
